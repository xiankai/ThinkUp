...
class TestOfOutreachPunchcardInsight extends ThinkUpUnitTestCase {
    ...
    public function testOutreachPunchcardInsight() {
        ...
        $post_dotw = date('N', strtotime($posts[0]->pub_date)); // Day of the week
        $post_hotd = date('G', strtotime($posts[0]->pub_date)); // Hour of the day
        ...
        'pub_date'=>$date_r.' 13:19:09', 'in_reply_to_post_id'=>133, 'reply_count_cache'=>0, 'is_protected'=>0));

        // Response between 1pm and 2pm
        $builders[] = FixtureBuilder::build('posts', array('id'=>137, 'post_id'=>137, 'author_user_id'=>7654321,
        'author_username'=>'twitteruser', 'author_fullname'=>'Twitter User', 'author_avatar'=>'avatar.jpg',
        'network'=>'twitter', 'post_text'=>'This is a reply.', 'source'=>'web',
        'pub_date'=>$date_r.' 13:21:13', 'in_reply_to_post_id'=>133, 'reply_count_cache'=>0, 'is_protected'=>0));

        // Response between 1pm and 2pm
        $builders[] = FixtureBuilder::build('posts', array('id'=>138, 'post_id'=>138, 'author_user_id'=>7654321,
        'author_username'=>'twitteruser', 'author_fullname'=>'Twitter User', 'author_avatar'=>'avatar.jpg',
        'network'=>'twitter', 'post_text'=>'This is a reply.', 'source'=>'web',
        'pub_date'=>$date_r.' 13:32:56', 'in_reply_to_post_id'=>135, 'reply_count_cache'=>0, 'is_protected'=>0));
        ...
        $this->assertPattern('/<strong>3 responses<\/strong> between <strong>1pm and 2pm<\/strong>/', $result->text);
        $this->assertPattern('/as compared to <strong>1 response<\/strong>/', $result->text);
        $this->assertPattern('/<strong>1 response<\/strong> between <strong>11am and 12pm<\/strong>/', $result->text);
    }
